...
<!-- ====================== MAIN ====================== -->
<main class="main">
<div class="welcome"><div><h1>Portfolio</h1><div class="date">09 Jun 2026</div></div><div class="sub-actions"><button class="btn"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg>Tambah Proyek</button></div></div><section class="vcard"><div class="pgrid" id="portGrid"></div></section>
</main>
...
const PORT=[
 {t:'Apartemen Green Park Tower',cat:'Insulasi Gedung',loc:'Jakarta',d:'2025',st:'pub'},
 {t:'Cold Storage Marunda',cat:'PU Panel',loc:'Bekasi',d:'2025',st:'pub'},
 {t:'Hotel Grand Serpong',cat:'Akustik',loc:'Tangerang',d:'2024',st:'pub'},
 {t:'Pabrik Tekstil Cikupa',cat:'Insulasi Industri',loc:'Tangerang',d:'2024',st:'pub'},
 {t:'RS Medika Tangerang',cat:'Partisi & Board',loc:'Tangerang',d:'2024',st:'draft'},
 {t:'Mall Cibubur Junction',cat:'Akustik',loc:'Depok',d:'2023',st:'pub'}
];
$('portGrid').innerHTML=PORT.map(p=>'<div class="pcard"><div class="pcover"><svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 21h18M5 21V8l9-3v16M14 21V10l5 2v9"/></svg>'+(p.st==='draft'?'<span class="pc-badge chip grey">Draft</span>':'<span class="pc-badge chip green"><span class="cdot"></span>Published</span>')+'</div>'
 +'<div class="pcard-body"><div class="pcard-cat">'+p.cat+'</div><div class="pcard-title">'+p.t+'</div><div class="pcard-sub">'+p.loc+'</div>'
 +'<div class="pcard-foot"><span>'+p.d+'</span><button class="btn ghost sm">Kelola</button></div></div></div>').join('');
