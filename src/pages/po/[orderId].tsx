...
import { AssignCollectorModal } from '@/components/orders/AssignCollectorModal';
										...
										<div className="flex-shrink-0 w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center shadow-lg">
											...
											>
												<path
													...
													d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.863-.833-2.633 0L4.168 16.5c-.77.833.192 2.5 1.732 2.5z"
												/>
											</svg>
										</div>
										<div className="ml-6 flex-1">
